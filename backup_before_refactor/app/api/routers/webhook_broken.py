# app/api/routers/webhook.py - Enhanced with Friend Events
...
@router.post("/webhook", summary="รับ Events จาก LINE Platform - Enhanced")
async def line_webhook(request: Request, db: AsyncSession = Depends(get_db)):
    # Wrap entire function in try-catch to prevent 500 errors
    try:
